...
metric = 'MSD'                                  # Default  
merge_scheme = 'inter'                          # {'inter', 'intra'}
...
if __name__ == '__main__':
    ...
    with open(f'{merge_scheme}_helm_scores.csv', 'w') as f:
